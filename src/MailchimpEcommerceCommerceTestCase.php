...
// variable_del('mailchimp_test_mode');
  ...
  public function testAddStoreNoList() {
    ...
    $this->assertText(t('Store Audience field is required.'), 'The text "Store Audience field is required." should appear on the page, indicating a form validation error.');
  }
